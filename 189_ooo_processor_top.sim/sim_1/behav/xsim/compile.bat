...
REM
REM Generated by Vivado on Sun Dec 14 13:46:40 -0800 2025
...
echo "xvlog --incr --relax -L uvm -prj top_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj top_tb_vlog.prj -log xvlog.log
